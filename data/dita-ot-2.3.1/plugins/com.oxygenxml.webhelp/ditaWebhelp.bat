...
set WEBHELP_JAVA=D:\IXIASOFT\outputgen_43\jre\bin\java.exe
set JAVA_HOME=D:\IXIASOFT\outputgen_43\jre
...
%WEBHELP_JAVA%^
 ...
 -lib "%DITA_OT_INSTALL_DIR%\plugins\com.oxygenxml.webhelp\lib\lucene-analyzers-common-4.7.2.jar"^
 -lib "%DITA_OT_INSTALL_DIR%\plugins\com.oxygenxml.webhelp\lib\lucene-analyzers-kuromoji-4.7.2.jar"^
 -lib "%DITA_OT_INSTALL_DIR%\plugins\com.oxygenxml.webhelp\lib\lucene-core-4.7.2.jar"^
 -lib "%DITA_OT_INSTALL_DIR%\plugins\com.oxygenxml.webhelp\lib\lucene-misc-4.7.2.jar"^
 -lib "%DITA_OT_INSTALL_DIR%\plugins\com.oxygenxml.webhelp\lib\lucene-queries-4.7.2.jar"^
 -lib "%DITA_OT_INSTALL_DIR%\plugins\com.oxygenxml.webhelp\lib\lucene-queryparser-4.7.2.jar"^
 -lib "%DITA_OT_INSTALL_DIR%\plugins\com.oxygenxml.webhelp\lib\lucene-suggest-4.7.2.jar"^
