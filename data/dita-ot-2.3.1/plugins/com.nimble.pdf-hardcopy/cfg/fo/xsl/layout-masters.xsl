...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template name="insertDraftWatermark">
        <xsl:if test="$DRAFT='yes'">
            <xsl:attribute name="background-image">url(Customization/OpenTopic/common/artwork/draft.png)</xsl:attribute>
    ...
    <xsl:template name="createDefaultLayoutMasters">
        <fo:layout-master-set>
            ...
            <fo:simple-page-master master-name="index-last" xsl:use-attribute-sets="simple-page-master">
                ...
                <fo:region-before region-name="last-index-header" xsl:use-attribute-sets="region-before"/>
                <fo:region-after region-name="last-index-footer" xsl:use-attribute-sets="region-after"/>
            </fo:simple-page-master>
            ...
            <fo:simple-page-master master-name="glossary-last" xsl:use-attribute-sets="simple-page-master">
                ...
                <fo:region-before region-name="last-glossary-header" xsl:use-attribute-sets="region-before"/>
                <fo:region-after region-name="last-glossary-footer" xsl:use-attribute-sets="region-after"/>
            </fo:simple-page-master>
